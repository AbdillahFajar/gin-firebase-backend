...
import (
	...
	"github.com/AbdillahFajar/gin-firebase-backend/config"
	"github.com/AbdillahFajar/gin-firebase-backend/models"
	"github.com/joho/godotenv"
)

// Tes tambahin data produk dari seed dan jalankan di terminal/cmd dengan go run seed/product-seed.go
func main() {
	godotenv.Load()
	config.InitDatabase()
	...
	log.Printf("Seed berhasil: %d produk ditambahkan", len(products)) //keterangan jika proses seed berhasil
}
