// Membuat koneksi ke database MySQL dengan GORM
package config
...
import (
	...
	"github.com/AbdillahFajar/gin-firebase-backend/models"
	"gorm.io/driver/mysql"
	"gorm.io/gorm"
	"gorm.io/gorm/logger"
)

// DB adalah instance GORM global yang dipakai di seluruh aplikasi var DB *gorm.DB
var DB *gorm.DB
...
func InitDatabase() {
	...
	//AutoMigrate: buat/update table sesuai struktur model
	//GORM akan membuat tabel jika belum ada. Fungsinya sama dengan php artisan migrate
	err = DB.AutoMigrate(
		&models.User{},
		&models.Product{},
	)
